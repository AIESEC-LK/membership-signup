                    ...
                    <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="hidden" name="university" value=7668 required >
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="faculty" value="" required>
                                    ...
                                    <option value="Commerce and Management Studies">Faculty of Commerce and Management Studies</option>
                                    <option value="Computing and Technology">Faculty of Computing and Technology</option>
                                    <option value="Medical">Faculty of Medical</option>
