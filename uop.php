                    ...
                    <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="hidden" name="university" value=7671 required >
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="faculty" value="" required>
                                    ...
                                    <option value="Veterinary Medicine and Animal Sciences">Faculty of Veterinary Medicine and Animal Sciences</option>
